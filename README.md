...
Usege:<br>
```
wget -O - https://raw.githubusercontent.com/yourname/tcping/main/install-tcping.sh | bash
```
Or:<br>
```
curl -sSL https://raw.githubusercontent.com/yourname/tcping/main/install-tcping.sh | bash
```
<br>
